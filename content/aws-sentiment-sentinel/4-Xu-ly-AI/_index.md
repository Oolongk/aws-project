...
![Bedrock](/images/youtube/4-Xu-ly-AI/Tranform-1.png)
2. Truy cập dịch vụ **Amazon Bedrock** -> Chọn **Model catalog**.
![Bedrock](/images/youtube/4-Xu-ly-AI/Bedrock-1.png)
3. Kéo xuống và tìm  **Claude haiku 4.5** và bấm vào.
![Bedrock](/images/youtube/4-Xu-ly-AI/Bedrock-2.png)
1. Kéo xuống và tìm mục **Model ID** và copy ID đó lại(sẽ dùng ở bước 3)
![Bedrock](/images/youtube/4-Xu-ly-AI/Bedrock-3.png)
---
...
![Transformer Lambda](/images/youtube/4-Xu-ly-AI/Tranformer-Lambda-1.png)
![Transformer Lambda](/images/youtube/4-Xu-ly-AI/Tranformer-Lambda-2.png)
...
![Transformer Lambda](/images/youtube/4-Xu-ly-AI/Tranformer-Lambda-6.png)
![Transformer Lambda](/images/youtube/4-Xu-ly-AI/Tranformer-Lambda-7.png)
...
3. Tại tab *Code*, chọn **+ Add trigger** để cấu hình luồng sự kiện:
   ...
   - **Suffix:** `.json`
   - Bấm **Add**.
![Transformer Lambda](/images/youtube/4-Xu-ly-AI/Tranformer-Lambda-3.png)
![Transformer Lambda](/images/youtube/4-Xu-ly-AI/Tranformer-Lambda-4.png)
![Transformer Lambda](/images/youtube/4-Xu-ly-AI/Tranformer-Lambda-5.png)
