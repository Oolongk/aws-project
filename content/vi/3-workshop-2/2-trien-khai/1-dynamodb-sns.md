...
weight: 1
date :  "2026-05-13" 
title: "Tạo DynamoDB & Cấu hình Amazon SNS"
chapter: false
pre: "<b>2.2.2.1. </b>"
---
...
![Tạo bảng DynamoDB](/aws-project/images/IoTSentinel/2-trien-khai/dynamodb-create.png?featherlight=false&width=90pc)

4. Ở phần **Table settings**, giữ nguyên lựa chọn **Default settings**.
![Tạo bảng DynamoDB](/aws-project/images/IoTSentinel/2-trien-khai/dynamodb-create-2.png?featherlight=false&width=90pc)
...
![Tạo SNS Topic](/aws-project/images/IoTSentinel/2-trien-khai/sns_topic.png?featherlight=false&width=90pc)
...
![Tạo Subscription](/aws-project/images/IoTSentinel/2-trien-khai/sns_sub.png?featherlight=false&width=90pc)
...
![Xác nhận Email](/aws-project/images/IoTSentinel/2-trien-khai/sns_confirm.png?featherlight=false&width=90pc)
![Xác nhận Email](/aws-project/images/IoTSentinel/2-trien-khai/sns_confirm_2.png?featherlight=false&width=90pc)
![Xác nhận Email](/aws-project/images/IoTSentinel/2-trien-khai/sns_confirm_3.png?featherlight=false&width=90pc)