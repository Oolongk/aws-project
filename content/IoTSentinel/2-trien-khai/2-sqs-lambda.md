...
![Tạo SQS Queue](/images/2-trien-khai/sqs_create.png?featherlight=false&width=90pc)
...
![Tạo SQS Queue](/images/2-trien-khai/sqs_create_2.png?featherlight=false&width=90pc)
...
![Cấp quyền cho Lambda](/images/2-trien-khai/lambda_create.png?featherlight=false&width=90pc)
...
![Cấp quyền cho Lambda](/images/2-trien-khai/lambda_iam_1.png?featherlight=false&width=90pc)

2. Nhấn **Add permissions** > **Attach policies**.
![Cấp quyền cho Lambda](/images/2-trien-khai/lambda_iam_2.png?featherlight=false&width=90pc)

3. Tìm và thêm các quyền: `AmazonSQSFullAccess`, `AmazonDynamoDBFullAccess`, `AmazonSNSFullAccess`.
![Cấp quyền cho Lambda](/images/2-trien-khai/lambda_iam_3.png?featherlight=false&width=90pc)
...
![Thêm Trigger SQS](/images/2-trien-khai/lambda_trigger_1.png?featherlight=false&width=90pc)

2. Chọn hàng đợi `IoT_Fleet_Queue` vừa tạo.
![Thêm Trigger SQS](/images/2-trien-khai/lambda_trigger_2.png?featherlight=false&width=90pc)
3. Nhấn **Add**.
