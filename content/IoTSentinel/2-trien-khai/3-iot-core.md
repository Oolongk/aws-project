...
![Tải chứng chỉ IoT](/images/IoTSentinel/2-trien-khai/iot_certs.png?featherlight=false&width=90pc)
...
![Cấu hình IoT Rule](/images/IoTSentinel/2-trien-khai/iot_rule_1.png?featherlight=false&width=90pc)

2. **Rule name**: `IoT_To_SQS_Rule`.
![Cấu hình IoT Rule](/images/IoTSentinel/2-trien-khai/iot_rule_2.png?featherlight=false&width=90pc)
...
3. **SQL statement**: Nhập câu lệnh để lấy toàn bộ dữ liệu:
   ...
   ```
4. Nhấn **Next**.
![Cấu hình IoT Rule](/images/IoTSentinel/2-trien-khai/iot_rule_3.png?featherlight=false&width=90pc)

5. **Attach action**: Chọn **SQS queue**.
   - Chọn hàng đợi: `IoT_Fleet_Queue`.
6. Nhấn **Create**.

![Cấu hình IoT Rule](/images/IoTSentinel/2-trien-khai/iot_rule_4.png?featherlight=false&width=90pc)
...
![Lấy IoT Endpoint từ Domain Configuration](/images/IoTSentinel/2-trien-khai/iot_endpoint_new.png?featherlight=false&width=90pc)
