...
![Tạo bảng DynamoDB](/images/2-trien-khai/dynamodb-create.png?featherlight=false&width=90pc)

4. Ở phần **Table settings**, giữ nguyên lựa chọn **Default settings**.
![Tạo bảng DynamoDB](/images/2-trien-khai/dynamodb-create-2.png?featherlight=false&width=90pc)

5. Kéo xuống dưới cùng và nhấn **Create table**. Quá trình tạo sẽ mất khoảng vài giây.

![DynamoDB Success](/images/2-trien-khai/dynamodb_success.png?featherlight=false&width=90pc)
...
![Tạo SNS Topic](/images/2-trien-khai/sns_topic.png?featherlight=false&width=90pc)
...
![Tạo Subscription](/images/2-trien-khai/sns_sub.png?featherlight=false&width=90pc)
...
![Xác nhận Email](/images/2-trien-khai/sns_confirm.png?featherlight=false&width=90pc)
![Xác nhận Email](/images/2-trien-khai/sns_confirm_2.png?featherlight=false&width=90pc)
![Xác nhận Email](/images/2-trien-khai/sns_confirm_3.png?featherlight=false&width=90pc)
